...
import { handlerSumbit, printTextarea, addImage } from '../../utils/mostHave';
...
const AddForm = () => {
  ...
  return (
    <form onKeyDown={dontFetch} encType="multipart/form-data">
      <PopUp
        visible={visible}
      ...
      <p><input type="file"
        ...
        ref={ref}
        required
        onChange={addImage.bind(null, ref, setData, data)} />
      ...
      <p><input type="text"
        ...
        id="recipes_anonce"
        maxLength={300}
        name="recipes_anonce" size={120} /></p>
